...
export const EditRequest = () => {
  ...
  const [request, { setQueryData }] = useQuery(getRequest, { where: { id: requestId } })
      ...
      <RequestForm
        ...
        onSubmit={async () => {
          try {
            ...
            router.push(`/requests/${updated.id}`)
          } catch (error) {
            console.log(error)
            alert("Error editing request " + JSON.stringify(error, null, 2))
          }
        }}
      />
    </div>
